...
Your task: Write a function that checks if there are two numbers in a sorted array that add up to a given target.
Example:
...
Output: true (because 2 + 4 = 6)
  ...
  const initialCode = `
# Python: Check if Two Numbers Add Up to Target
def has_two_sum(arr, target):
    # Write your code here
    return False  # Replace this with your implementation

# Example Test Case
print(has_two_sum([1, 2, 3, 4, 6], 6))  # Expected Output: True
  `;
...
print(has_two_sum${testCase.input})`,
  ...
  return (
    <DataStructurePage
      ...
      moduleId="TwoPointer" // Unique module identifier
